...
public class Cliente extends Persona {
    ...
    public void DatosJSON() {
        ...
        try (BufferedWriter writer = new BufferedWriter(new FileWriter("archivos.json",true))) {
            writer.write(json);
    ...
    public void MostrarDatosJSON() {
        ...
        try (BufferedReader reader = new BufferedReader(new FileReader("archivos.json"))) {
            ...
            System.out.println("Datos leídos de archivos.json:");
